      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)', fontWeight: '500' }}>Partner Universities</div>
            </div>
            <div style={{
              width: '1px',
              background: 'rgba(255,255,255,0.2)'
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)', fontWeight: '500' }}>Countries Worldwide</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            All programs are internationally accredited through our partnerships with 
            <span style={{ color: 'white', fontWeight: '600' }}> 500+ universities </span> 
            across 
            <span style={{ color: 'white', fontWeight: '600' }}> 50+ countries</span>.
          </p>
        </div>
      </div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                  {selectedProgram.subtypes.map((subtype: string, idx: number) => (
                    <span
                      ...
                      style={{
                        padding: '10px 18px',
                        background: `${selectedProgram.color}30`,
                        borderRadius: '50px',
                        fontSize: '14px',
                        fontWeight: '600',
                        color: selectedProgram.color === '#1E3A5F' ? '#8BB4FF' : selectedProgram.color
                      }}
                    >
                      {subtype}
                    </span>
